...
console.log(supagradient(`🗞   Fetching GraphQL Schema from ${process.env.SUPABASE_PROJECT_REF} ...`));

fetchGraphQLSchema(`https://${process.env.NEXT_PUBLIC_SUPABASE_PROJECT_REF}.supabase.co/graphql/v1`, {
    readable: true,
}).then((schema) => {
