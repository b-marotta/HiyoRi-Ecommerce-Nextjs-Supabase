...
async function EditCollectionPage({ params: { collectionId } }: EditCollectionPageProps) {
    ...
    return (
        <AdminShell heading="Add Collection" description="Input the field below, after that press add Collections.">
            <div className="">
