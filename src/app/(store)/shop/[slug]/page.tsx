...
import { BuyNowButton, ProductCard, ProductImageShowcase } from "@/features/products";
...
async function ProductDetailPage({ params }: Props) {
    ...
    if (!data || !data.productsCollection || !data.productsCollection.edges) return notFound();

    const { id, name, description, price, commentsCollection, totalComments } = data.productsCollection.edges[0].node;
    ...
    return (
        <Shell>
            <div className="grid grid-cols-12 gap-x-8">
                ...
                <div className="col-span-12 md:col-span-5">
                    <section className="flex justify-between items-start max-w-lg">
                        <div>
                            <h1 className="text-4xl font-semibold tracking-wide mb-3">{name}</h1>
                    ...
                    <section>
                        ...
                        <Accordion type="single" collapsible>
                            ...
                            <AccordionItem value="item-3">
                                ...
                                <AccordionContent>
                                    Shipping & Returns Spend $80 to receive free shipping for a limited time. Oversized items require additional handling fees. Learn more Except
                                    for furniture, innerwear, and food, merchandise can be returned or exchanged within 30 days of delivery. Learn more
                                </AccordionContent>
                            </AccordionItem>
                        </Accordion>
                    </section>
            ...
            <ProductCommentsSection comments={commentsCollection ? commentsCollection.edges.map(({ node }) => node) : []} totalComments={totalComments} />
        </Shell>
    );
}
