    ...
    return (
        <Shell>
            <div className="grid grid-cols-12 gap-x-8">
                <div className="relative col-span-12 space-y-8 md:col-span-7">
                    <ProductImageShowcase data={data.productsCollection.edges[0].node} />
                </div>

                <div className="col-span-12 md:col-span-5">
                    <section className="flex max-w-lg items-start justify-between">
                        <div>
                            <h1 className="mb-3 text-4xl font-semibold tracking-wide">{name}</h1>
                            <p className="mb-3 text-2xl font-semibold">{`$${price}`}</p>
                        </div>
                        <AddToWishListButton productId={id} />
                    </section>

                    <section className="mb-8 flex items-end space-x-5">
                        <Suspense>
                        ...
                        <Accordion type="single" collapsible>
                            ...
                            <AccordionItem value="item-3">
                                ...
                                <AccordionContent>
                                    ...
                                    limited time. Oversized items require additional handling fees.
                                    Learn more Except for furniture, innerwear, and food,
            ...
            <ProductCommentsSection
                comments={
                    commentsCollection ? commentsCollection.edges.map(({ node }) => node) : []
                }
