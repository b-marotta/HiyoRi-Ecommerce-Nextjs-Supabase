...
const relevantEvents = new Set(["product.created", "product.updated", "price.created", "price.updated", "payment_intent.succeeded", "checkout.session.completed"]);
                    ...
                    if (checkoutSession.status === "complete") {
                        ...
                        const updatedOrder = await db
                            ...
                            .set({
                                ...
                                stripe_payment_intent_id: checkoutSession.payment_intent.toString(),
