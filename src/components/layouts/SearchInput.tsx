    ...
    return (
        <Form {...form}>
            <form
                ...
                className="relative flex-1 rounded-full bg-background/95 p-4 backdrop-blur supports-[backdrop-filter]:bg-background/60"
            >
                <Icons.search
                    className={cn(
                ...
                <Button className="absolute right-4 top-4" type="submit" variant="link">
                    <Icons.search
                        className={cn(
                            ...
                            isFocused ? 'opacity-1 scale-1' : 'scale-0 opacity-0',
                        )}
                    />
                </Button>
            </form>
