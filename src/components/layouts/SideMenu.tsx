...
export function SideMenu() {
    return (
        <Sheet>
            ...
            <SheetContent side="left" className="w-full md:max-w-xl pr-[4rem]" closeButtonClassName="w-6 h-6 md:w-10 md:h-10">
                ...
                <SheetFooter className="fixed grid bottom-[96px] ml-12 md:ml-[96px] space-x-0">
                    ...
                    <div className="mb-8 text-muted-foreground">
                        ...
                        <p className="text-xs md:text-sm ml-0">
                            ...
                            <Link className="hover:underline hover:text-primary" href={`mailto:${siteConfig.email}`}>
                                {siteConfig.email}
                            </Link>
                        </p>
                    </div>
