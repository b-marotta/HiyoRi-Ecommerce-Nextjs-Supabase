...
const CollectionsColumns: ColumnDef<{
...
}>[] = [
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <Link href={`/admin/collections/${collection.id}`} className="text-center font-medium capitalize px-3 hover:underline">
                    {collection.label}
                </Link>
            );
        },
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return <p className="font-medium capitalize px-3 hover:underline">{collection.title}</p>;
        },
    },
    {
        id: "actions",
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="flex flex-col items-start">
                        ...
                        <Link href={`/admin/collections/${collection.id}`} className={buttonVariants({ variant: "ghost" })}>
                            Edit Collections
                        </Link>
