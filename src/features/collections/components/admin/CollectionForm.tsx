            ...
            <form id="project-form" className="gap-x-5 flex gap-y-5 flex-col px-3" onSubmit={onSubmit}>
                <div className="flex flex-col gap-y-5 max-w-[500px]">
                    <FormItem>
                        ...
                        <FormControl>
                            <Input aria-invalid={!!form.formState.errors.label} placeholder="Type Collection label." {...register("label")} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    <FormItem>
                        ...
                        <FormControl>
                            <Input aria-invalid={!!form.formState.errors.title} placeholder="Type Collection title." {...register("title")} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Input defaultValue={collection?.slug} aria-invalid={!!form.formState.errors.slug} placeholder="Type Collection slug." {...register("slug")} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <Suspense>
                                    <div className="">
                                        <ImageDialog defaultValue={collection?.featured_image_id} onChange={field.onChange} value={field.value} />
                                    </div>
                                </Suspense>
