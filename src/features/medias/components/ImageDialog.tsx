    ...
    return (
        <div>
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogTrigger>
                    <div>{value ? <ImagePreviewCard key={value} onClick={() => {}} mediaId={value} /> : "Select / Add Image"}</div>
                </DialogTrigger>
                ...
                <DialogContent className="max-w-[1080px] min-h-full md:min-h-[480px]">
                    <DialogHeader>
                        ...
                        <Suspense>
                            <UploadMediaContainer onClickItemsHandler={onClickHandler} defaultImageId={defaultValue} />
                        </Suspense>
                    </DialogHeader>
                </DialogContent>
            </Dialog>
