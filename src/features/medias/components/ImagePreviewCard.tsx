        ...
        return (
            <Card className="group relative">
                <div className="relative">
                    <Image className="group-hover:opacity-80 transition-all duration-200" src={keytoUrl(media.key)} alt={media.alt} width={120} height={120} />
                    <Icons.edit className={cn("absolute w-5 h-5 right-2 top-2 hidden group-hover:block")} />
                </div>
            </Card>
        );
    }
