            ...
            <form id="project-form" className="gap-x-5 flex gap-y-5 flex-col px-3" onSubmit={onSubmit}>
                <div className="flex flex-col gap-y-5 max-w-[500px]">
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            <Input aria-invalid={!!form.formState.errors.alt} placeholder="Media Alt." {...register("alt")} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                </div>

                <DisabledFormData label={"Created At:"} data={media.createdAt.toString()} />
                <DisabledFormData label={"Updated At:"} data={media.updatedAt.toString()} />

                <AlertDialog>
                    <AlertDialogTrigger className="text-red-600 text-left">Delete Permanently</AlertDialogTrigger>
                    <AlertDialogContent>
                        <AlertDialogHeader>
