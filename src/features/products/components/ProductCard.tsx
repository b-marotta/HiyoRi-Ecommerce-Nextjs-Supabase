...
export function ProductCard({ className, product, ...props }: ProductCardProps) {
    ...
    return (
        <Card className={cn("w-full border-0 rounded-lg py-3 ", className)} {...props}>
            ...
            <CardHeader className="p-0 mb-3 md:mb-5">
                ...
                <div className="hidden md:block">
                    <CardDescription className="max-w-[240px] line-clamp-2">{product.description}</CardDescription>
                </div>
