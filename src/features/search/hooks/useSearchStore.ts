...
export const createQueryString = (query: SearchQuery, params: Record<string, string | number | string[] | null>) => {
    ...
    if (query.priceRange) {
        newSearchParams.set("price_range", `${query.priceRange[0]}-${query.priceRange[1]}`);
    }
