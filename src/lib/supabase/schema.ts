...
import { boolean, decimal, foreignKey, integer, json, pgTable, primaryKey, text, timestamp, uuid, varchar } from "drizzle-orm/pg-core";
...
export const products = pgTable(
    "products",
    {
        ...
        rating: decimal("rating", { precision: 2, scale: 1 }).notNull().default("4"),
