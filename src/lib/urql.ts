import { CombinedError, cacheExchange, createClient, fetchExchange } from "@urql/core";
...
export const createUrqlClient = (access_token?: string) => registerUrql(() => makeClient(access_token)).getClient();
